...
def test_successful_yml_fetch(monkeypatch) -> None:
    ...
    content = base._load_schema_file()
...
def test_unreadable_file(monkeypatch, caplog) -> None:
    ...
    monkeypatch.setattr('django_swagger_tester.response_validation.static_schema.os.path.isfile', mocked_isfile)
