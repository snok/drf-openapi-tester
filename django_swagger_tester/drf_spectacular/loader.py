...
class LoadDrfSpectacularSchema:
    def __init__(self, route: str, method: str, status_code: Optional[int] = None, **kwargs) -> None:
        """
        Loads OpenAPI schema when schema is dynamically generated by drf_spectacular.
        ...
        self.route = self.get_drf_spectacular_compatible_route(route)
    ...
    def validation(self) -> None:
        ...
        3. drf_spectacular is in the projects installed_apps
        """
        try:
    ...
    def get_path_prefix(self) -> str:
        ...
        Drf_spectacular `cleans` schema paths by finding recurring path patterns,
    ...
    def get_drf_spectacular_compatible_route(self, route: str) -> str:
        """
