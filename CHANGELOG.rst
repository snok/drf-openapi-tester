...
Version 2.0.0 introduces new required package settings, which means existing implementations will need to set up their ``OPENAPI_RESPONSE_TESTER`` settings again before package functions will run.
